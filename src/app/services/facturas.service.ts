...
import { SaleDetailsData, SaleDetailsDataForList } from '../models/sale-details-data';
...
export class FacturasService
{
    ...
    private apiUrlSaleDetailsBySaleId = 'http://127.0.0.1:8000/saledetailsbysaleid';
    ...
    getSaleDetailsDataBySaleId(id: number): Observable<SaleDetailsDataForList[]>
    {
        return this.http.get<SaleDetailsDataForList[]>(`${this.apiUrlSaleDetailsBySaleId}/${id}`);
    }
